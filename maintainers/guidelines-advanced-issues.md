# Advanced Issue Guidelines — Hiero Rust SDK
...
### Implement HIP-1261 fee estimate query support in the Rust SDK

The Hiero Rust SDK doesn’t currently support fee estimate queries as defined in  
...
- Public APIs  
- Internal request/response handling (protobuf conversion via `FromProtobuf`/`ToProtobuf`)  
- Tests and examples  
...
2. Design the Rust SDK API surface for fee estimate queries  
3. Implement the feature across the SDK, including:
   - Public-facing query or transaction structs  
   - Internal request/response handling with protobuf conversion  
   - Validation and error handling  
4. Add unit and integration tests  
5. Provide at least one usage example in `examples/`  
