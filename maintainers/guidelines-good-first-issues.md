# Good First Issue Guidelines — Hiero Rust SDK
...
-   Small type improvements (like tightening generic bounds or replacing `Box<dyn Any>` with concrete types)
-   Fix specific Clippy lint warning
