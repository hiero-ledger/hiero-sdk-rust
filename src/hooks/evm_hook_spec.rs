...
impl EvmHookSpec {
    ...
    /// Create a new `EvmHookSpec` with a contract ID.
...
mod tests {
    ...
    fn test_evm_hook_spec_creation() {
        ...
        let spec = EvmHookSpec::with_contract_id(contract_id.clone());
    ...
    fn test_evm_hook_spec_protobuf_roundtrip() {
        ...
        let original = EvmHookSpec::with_contract_id(contract_id);
